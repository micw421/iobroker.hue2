...
export class ObjectManager {
    ...
    private async syncZigbeeConnectivityStates(baseId: string, r: HueResource): Promise<void> { if (typeof r.status === 'string') await this.createState(`${baseId}.status`, { name: 'Status', type: 'string', role: 'text', value: r.status, resource: r }); }
